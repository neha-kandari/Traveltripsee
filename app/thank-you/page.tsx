    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-orange-50 via-white to-pink-50 px-4 py-12">
      ...
      <div className="relative z-10 max-w-lg w-full text-center">
        ...
        <p className="text-lg text-gray-600 mb-2 leading-relaxed">
          We&apos;ve received your details and we&apos;re thrilled to help you plan your dream trip! 🌍
        </p>
        ...
        <div className="bg-white border border-orange-100 rounded-2xl p-6 mb-8 text-left shadow-lg">
          ...
          <ul className="space-y-3 text-sm text-gray-600">
            <li className="flex items-start gap-3">
              ...
              <span>Our travel experts will review your requirements</span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>You&apos;ll receive a personalized trip plan on WhatsApp within 24 hours</span>
            </li>
            <li className="flex items-start gap-3">
              ...
              <span>We&apos;ll finalize your perfect itinerary together — and get you ready to go!</span>
            </li>
          </ul>
        </div>
