...
const MaldivesPage = ({ initialPackages = [] }: { initialPackages?: any[] }) => {
  ...
  const sliderImages = [
    ...
    {
      src: "/Destination/MaldivesHero/hanifaru-bay.webp",
    ...
    {
      src: "/Destination/MaldivesHero/male-atoll.webp",
