...
const ThailandPage = ({ initialPackages = [] }: { initialPackages?: any[] }) => {
    ...
    return apiPackages.map((apiPkg: any) => {
      ...
      if (apiPkg.image) {
        ...
        if (apiPkg.image === '/' || 
            ...
            !apiPkg.image) {
          apiPkg.image = "/Destination/ThailandHero/image1.webp";
        }
      } else {
  ...
  const sliderImages = [
    {
      src: "/Destination/ThailandHero/image1.webp",
      alt: "Golden Budha",
      title: "Golden Budha",
    ...
    {
      src: "/Destination/ThailandHero/image2.webp",
    ...
    {
      src: "/Destination/ThailandHero/image3.webp",
      alt: "Wat Arun Temple",
    ...
    {
      src: "/Destination/ThailandHero/image4.webp",
      alt: "Phi Phi Islands",
                    ...
                    {/* Package Image */}
                      ...
                      <Image
                        ...
                        onError={(e) => {
                          ...
                          target.src = "/Destination/ThailandHero/image1.webp"; // Fallback image
                        }}
                      />
                    </div>
